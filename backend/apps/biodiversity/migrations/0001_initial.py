    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(default='Colombia', max_length=50, verbose_name='country')),
                ('department', models.CharField(default='Tolima', max_length=50, verbose_name='department')),
                ('municipality', models.CharField(default='Ibagué', max_length=50, verbose_name='municipality')),
                ('site', models.CharField(blank=True, max_length=50, verbose_name='site')),
                ('populated_center', models.CharField(blank=True, max_length=50, verbose_name='populated center')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('place', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='biodiversity_records', to='biodiversity.place', verbose_name='place')),
            ],
            options={
