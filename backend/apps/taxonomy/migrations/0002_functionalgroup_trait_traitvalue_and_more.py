    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        help_text="unique identifier for the functional group",
                        unique=True,
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="description of the functional group",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("CARBON", "carbon sequestration index"),
                            ("SHADE", "shade index"),
                            ("CANOPY", "maximum diameter of canopy (m)"),
                            ("HEIGHT", "maximum total height (m)"),
                        ],
                        max_length=6,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "min_value",
                    models.FloatField(
                        help_text="minimum value for this trait in the functional group",
                ...
                (
                    "max_value",
                    models.FloatField(
                        help_text="maximum value for this trait in the functional group",
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                ...
                help_text="common local use of the species",
                max_length=255,
                verbose_name="use",
            ),
        ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("genus", "name"), name="unique_genus_species"
            ),
        ),
        migrations.AddField(
