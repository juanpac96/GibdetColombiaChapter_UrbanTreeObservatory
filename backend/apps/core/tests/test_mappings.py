...
class MappingUtilsTestCase(TestCase):
    ...
    def test_get_mapped_value_exact_match(self):
        ...
        self.assertEqual(
            get_mapped_value('Exótica', ORIGIN_MAPPINGS),
    ...
    def test_get_mapped_value_default(self):
        ...
        self.assertEqual(
            get_mapped_value('Unknown', ORIGIN_MAPPINGS, default='DEFAULT'),
            'DEFAULT'
        )
    ...
    def test_get_mapped_value_none_input(self):
        ...
        self.assertEqual(
            get_mapped_value(None, ORIGIN_MAPPINGS, default='DEFAULT'),
            'DEFAULT'
        )
    ...
    def test_origin_mappings(self):
        ...
        self.assertEqual(
            get_mapped_value('Nativa', ORIGIN_MAPPINGS),
