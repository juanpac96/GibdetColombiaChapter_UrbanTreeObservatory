    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated at')),
                ('min_value', models.FloatField(blank=True, help_text='Minimum value for this trait in the functional group', null=True, validators=[django.core.validators.MinValueValidator(0.0)], verbose_name='minimum value')),
                ('max_value', models.FloatField(blank=True, help_text='Maximum value for this trait in the functional group', null=True, validators=[django.core.validators.MinValueValidator(0.0)], verbose_name='maximum value')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gbif_id', models.PositiveIntegerField(blank=True, help_text='GBIF species identifier', null=True, verbose_name='GBIF ID')),
        ...
        migrations.AddConstraint(
            model_name='traitvalue',
            constraint=models.CheckConstraint(condition=models.Q(('min_value__isnull', True), ('min_value__gte', 0), _connector='OR'), name='min_value_greater_than_zero'),
        ),
        migrations.AddConstraint(
            model_name='traitvalue',
            constraint=models.CheckConstraint(condition=models.Q(('max_value__isnull', True), ('max_value__gte', 0), _connector='OR'), name='max_value_greater_than_zero'),
        ),
    ]
